            ...
            return (
                <div className='min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-900 p-4'>
                    <div className='max-w-md w-full bg-white dark:bg-neutral-800 shadow-lg rounded-lg p-8 text-center'>
                        ...
                        <h2 className='text-2xl font-bold text-netural-800 dark:text-white mb-4'>
                            Oh no! Something went wrong...
                        </h2>
                        <p className='text-neutral-600 dark:text-neutral-300 mb-6'>
                            Try refreshing the page. Come back later if the problem persists.
                        </p>
                        <button onClick={() => window.location.reload()} className='px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition-colors'>
                            Refresh This Page
                        </button>
                    </div>
                </div>
